...
export const GlobalSelectors = ({ id }: Props) => {
  switch (id) {
    case "change_theme":
      return (
    ...
    case "weather_icon":
      return (
        ...
        >
          <path
            fill="url(#a)"
            d="M59.523 88.014c15.74 0 28.501-12.76 28.501-28.5s-12.76-28.5-28.501-28.5c-15.741 0-28.502 12.76-28.502 28.5s12.761 28.5 28.502 28.5Z"
          />
          <path
            fill="#FFB300"
            d="m86.308 5.951-6.697 16.171c-2.184 5.267-10.084 1.995-7.901-3.272l6.698-16.17c2.183-5.267 10.084-1.996 7.9 3.271Zm-39.024 94.204-6.697 16.171c-2.184 5.267-10.084 1.995-7.901-3.272l6.698-16.17c2.183-5.267 10.084-1.996 7.9 3.271Zm69.042-59.56-16.172 6.698c-5.267 2.184-8.539-5.717-3.272-7.9l16.172-6.697c5.267-2.183 8.539 5.717 3.272 7.9ZM22.118 79.619 5.946 86.316c-5.267 2.183-8.54-5.717-3.272-7.9l16.172-6.698c5.267-2.183 8.539 5.717 3.272 7.9Zm90.936 6.703-16.172-6.697c-5.267-2.183-1.995-10.083 3.272-7.9l16.172 6.697c5.267 2.183 1.995 10.083-3.272 7.9ZM18.846 47.3 2.674 40.602c-5.267-2.183-1.995-10.084 3.272-7.9l16.172 6.697c5.267 2.183 1.995 10.083-3.272 7.9ZM40.58 2.674l6.698 16.17c2.183 5.267-5.718 8.54-7.901 3.272L32.68 5.946c-2.183-5.267 5.718-8.539 7.9-3.272Zm39.024 94.204 6.698 16.171c2.183 5.267-5.718 8.538-7.9 3.272l-6.699-16.171c-2.183-5.267 5.718-8.539 7.9-3.272Z"
          />
          <defs>
            <linearGradient
              id="a"
